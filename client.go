...
type Client interface {
	...
	GetIncomeStatementConsolidated(request.GetIncomeStatement) (response.ConsolidatedIncomeStatements, response.Credits, error)
	GetBalanceSheet(request.GetBalanceSheet) (response.BalanceSheets, response.Credits, error)
	GetBalanceSheetConsolidated(request.GetBalanceSheet) (response.ConsolidatedBalanceSheets, response.Credits, error)
	GetCashFlow(request.GetCashFlow) (response.CashFlows, response.Credits, error)
	GetCashFlowConsolidated(request.GetCashFlow) (response.ConsolidatedCashFlows, response.Credits, error)
