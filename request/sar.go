...
// GetSAR represents the request parameters for the Parabolic SAR (SAR) technical indicator endpoint.
type GetSAR struct {
	APIKey
	...
	Acceleration  float64 `schema:"acceleration,omitempty"`
	Maximum       float64 `schema:"maximum,omitempty"`
