				...
				BalanceSheet: []response.BalanceSheet{
					{
						...
						Assets: response.BalanceSheetAssets{
							CurrentAssets: response.BalanceSheetCurrentAssets{
								Cash:                      null.FloatFrom(17305000000),
								CashEquivalents:           null.FloatFrom(17635000000),
								CashAndCashEquivalents:    null.FloatFrom(34940000000),
								OtherShortTermInvestments: null.FloatFrom(27699000000),
								AccountsReceivable:        null.FloatFrom(26278000000),
								OtherReceivables:          null.FloatFrom(25228000000),
								Inventory:                 null.FloatFrom(6580000000),
								PrepaidAssets:             null.Float{},
								RestrictedCash:            null.Float{},
								AssetsHeldForSale:         null.Float{},
								HedgingAssets:             null.Float{},
								OtherCurrentAssets:        null.FloatFrom(14111000000),
								TotalCurrentAssets:        null.FloatFrom(134836000000),
							},
							NonCurrentAssets: response.BalanceSheetNonCurrentAssets{
								Properties:                  null.FloatFrom(0),
								LandAndImprovements:         null.FloatFrom(20041000000),
								MachineryFurnitureEquipment: null.FloatFrom(78659000000),
								ConstructionInProgress:      null.Float{},
								Leases:                      null.FloatFrom(11023000000),
								AccumulatedDepreciation:     null.FloatFrom(-70283000000),
								Goodwill:                    null.Float{},
								InvestmentProperties:        null.Float{},
								FinancialAssets:             null.Float{},
								IntangibleAssets:            null.Float{},
								InvestmentsAndAdvances:      null.FloatFrom(127877000000),
								OtherNonCurrentAssets:       null.FloatFrom(48849000000),
								TotalNonCurrentAssets:       null.FloatFrom(216166000000),
							},
							TotalAssets: null.FloatFrom(351002000000),
						},
						Liabilities: response.BalanceSheetLiabilities{
							CurrentLiabilities: response.BalanceSheetCurrentLiabilities{
								AccountsPayable:         null.FloatFrom(54763000000),
								AccruedExpenses:         null.Float{},
								ShortTermDebt:           null.FloatFrom(15613000000),
								DeferredRevenue:         null.FloatFrom(7612000000),
								TaxPayable:              null.Float{},
								Pensions:                null.Float{},
								OtherCurrentLiabilities: null.FloatFrom(47493000000),
								TotalCurrentLiabilities: null.FloatFrom(125481000000),
							},
							NonCurrentLiabilities: response.BalanceSheetNonCurrentLiabilities{
								LongTermProvisions:           null.Float{},
								LongTermDebt:                 null.FloatFrom(109106000000),
								ProvisionForRisksAndCharges:  null.FloatFrom(24689000000),
								DeferredLiabilities:          null.Float{},
								DerivativeProductLiabilities: null.Float{},
								OtherNonCurrentLiabilities:   null.FloatFrom(28636000000),
								TotalNonCurrentLiabilities:   null.FloatFrom(162431000000),
							},
							TotalLiabilities: null.FloatFrom(287912000000),
						},
						ShareholdersEquity: response.BalanceSheetShareholdersEquity{
							CommonStock:             null.FloatFrom(57365000000),
							RetainedEarnings:        null.FloatFrom(5562000000),
							OtherShareholdersEquity: null.FloatFrom(163000000),
							TotalShareholdersEquity: null.FloatFrom(63090000000),
							AdditionalPaidInCapital: null.Float{},
							TreasuryStock:           null.Float{},
							MinorityInterest:        null.Float{},
						},
					},
				},
			},
				...
				CashFlow: []response.CashFlow{
					{
						...
						OperatingActivities: response.CashFlowOperatingActivities{
							NetIncome:              null.FloatFrom(34630000000),
							Depreciation:           null.FloatFrom(2697000000),
							DeferredTaxes:          null.FloatFrom(682000000),
							StockBasedCompensation: null.FloatFrom(2265000000),
							OtherNonCashItems:      null.FloatFrom(167000000),
							AccountsReceivable:     null.FloatFrom(-13746000000),
							AccountsPayable:        null.FloatFrom(19813000000),
							OtherAssetsLiabilities: null.FloatFrom(458000000),
							OperatingCashFlow:      null.FloatFrom(46966000000),
						},
						InvestingActivities: response.CashFlowInvestingActivities{
							CapitalExpenditures:    null.FloatFrom(-2803000000),
							NetIntangibles:         null.Float{},
							NetAcquisitions:        null.Float{},
							PurchaseOfInvestments:  null.FloatFrom(-34913000000),
							SaleOfInvestments:      null.FloatFrom(21984000000),
							OtherInvestingActivity: null.FloatFrom(-374000000),
							InvestingCashFlow:      null.FloatFrom(-16106000000),
						},
						FinancingActivities: response.CashFlowFinancingActivities{
							LongTermDebtIssuance:  null.Float{},
							LongTermDebtPayments:  null.FloatFrom(0),
							ShortTermDebtIssuance: null.FloatFrom(-1000000000),
							CommonStockIssuance:   null.Float{},
							CommonStockRepurchase: null.FloatFrom(-20478000000),
							CommonDividends:       null.FloatFrom(-3732000000),
							OtherFinancingCharges: null.FloatFrom(-2949000000),
							FinancingCashFlow:     null.FloatFrom(-28159000000),
						},
						EndCashPosition: null.FloatFrom(38630000000),
						IncomeTaxPaid:   null.FloatFrom(5235000000),
						InterestPaid:    null.FloatFrom(531000000),
						FreeCashFlow:    null.FloatFrom(49769000000),
					},
				},
			},
			want1:       response.NewCreditsImpl(100, 100),
				...
				Splits: []response.SplitEvent{
					{
						...
						FromFactor:  null.FloatFrom(4),
						ToFactor:    null.FloatFrom(1),
					},
				},
			},
			...
			want: response.SplitsCalendar{
				{
					...
					FromFactor:  null.FloatFrom(1),
					ToFactor:    null.FloatFrom(2),
				},
			},
			want1:       response.NewCreditsImpl(100, 100),
			wantErr:     "",
...
func Test_client_GetIncomeStatementConsolidated(t *testing.T) {
	runConsolidatedStatementTest(
		t,
		request.GetIncomeStatement{Symbol: "AAPL"},
		`{"income_statement":[{"gross_profit":{"gross_profit_value":12.5},"fiscal_date":"2025-12-31"}],"status":"ok"}`,
		response.ConsolidatedIncomeStatements{
			IncomeStatement: []response.ConsolidatedIncomeStatement{{FiscalDate: "2025-12-31", GrossProfit: response.ConsolidatedIncomeStatementGrossProfit{GrossProfitValue: null.FloatFrom(12.5)}}},
			Status:          "ok",
		},
		"/income_statement/consolidated?symbol=AAPL",
		func(httpCli *HTTPCli, url string) interface{} {
			return client{getIncomeStatementConsolidated: NewEndpoint[request.GetIncomeStatement, response.ConsolidatedIncomeStatements, response.Credits, error](httpCli, url+"/income_statement/consolidated")}
		},
		func(cli interface{}, req request.GetIncomeStatement) (response.ConsolidatedIncomeStatements, response.Credits, error) {
...
func Test_client_GetBalanceSheetConsolidated(t *testing.T) {
	runConsolidatedStatementTest(
		t,
		request.GetBalanceSheet{Symbol: "AAPL"},
		`{"balance_sheet":[{"assets":{"current_assets":{"inventory":{"total_inventory":12.5}}},"fiscal_date":"2025-12-31"}],"status":"ok"}`,
		response.ConsolidatedBalanceSheets{
			BalanceSheet: []response.ConsolidatedBalanceSheet{{FiscalDate: "2025-12-31", Assets: response.ConsolidatedBalanceSheetAssets{CurrentAssets: response.ConsolidatedBalanceSheetCurrentAssets{Inventory: response.ConsolidatedBalanceSheetInventory{TotalInventory: null.FloatFrom(12.5)}}}}},
			Status:       "ok",
		},
		"/balance_sheet/consolidated?symbol=AAPL",
		func(httpCli *HTTPCli, url string) interface{} {
			return client{getBalanceSheetConsolidated: NewEndpoint[request.GetBalanceSheet, response.ConsolidatedBalanceSheets, response.Credits, error](httpCli, url+"/balance_sheet/consolidated")}
		},
		func(cli interface{}, req request.GetBalanceSheet) (response.ConsolidatedBalanceSheets, response.Credits, error) {
...
func Test_client_GetCashFlowConsolidated(t *testing.T) {
	runConsolidatedStatementTest(
		t,
		request.GetCashFlow{Symbol: "AAPL"},
		`{"cash_flow":[{"cash_flow_from_operating_activities":{"operating_cash_flow":12.5},"fiscal_date":"2025-12-31"}],"status":"ok"}`,
		response.ConsolidatedCashFlows{
			CashFlow: []response.ConsolidatedCashFlow{{FiscalDate: "2025-12-31", CashFlowFromOperatingActivities: response.ConsolidatedCashFlowOperatingActivities{OperatingCashFlow: null.FloatFrom(12.5)}}},
			Status:   "ok",
		},
		"/cash_flow/consolidated?symbol=AAPL",
		func(httpCli *HTTPCli, url string) interface{} {
			return client{getCashFlowConsolidated: NewEndpoint[request.GetCashFlow, response.ConsolidatedCashFlows, response.Credits, error](httpCli, url+"/cash_flow/consolidated")}
		},
		func(cli interface{}, req request.GetCashFlow) (response.ConsolidatedCashFlows, response.Credits, error) {
			...
			want: response.Statistics{
				...
				Statistics: response.StatisticsValues{
					ValuationsMetrics: response.StatisticsValuationsMetrics{
						MarketCapitalization: null.FloatFrom(2546807865344),
						EnterpriseValue:      null.FloatFrom(2620597731328),
					...
					Financials: response.StatisticsFinancials{
						...
						IncomeStatement: response.StatisticsIncomeStatement{
							RevenueTTM:                 null.FloatFrom(347155005440),
							RevenuePerShareTTM:         null.FloatFrom(20.61),
							QuarterlyRevenueGrowth:     null.FloatFrom(0.364),
							GrossProfitTTM:             null.FloatFrom(104956000000),
							EBITDA:                     null.FloatFrom(110934999040),
							NetIncomeToCommonTTM:       null.FloatFrom(86801997824),
						...
						BalanceSheet: response.StatisticsBalanceSheet{
							...
							TotalCashMRQ:         null.FloatFrom(61696000000),
							TotalCashPerShareMRQ: null.FloatFrom(3.732),
							TotalDebtMRQ:         null.FloatFrom(135491002368),
						...
						CashFlow: response.StatisticsCashFlow{
							OperatingCashFlowTTM:   null.FloatFrom(104414003200),
							LeveredFreeCashFlowTTM: null.FloatFrom(80625876992),
						},
					},
					StockStatistics: response.StockStatistics{
						SharesOutstanding:               null.FloatFrom(16530199552),
						FloatShares:                     null.FloatFrom(16513305231),
	...
	}{
		{
			...
			args: args{
				...
				url: mockServerWithURL(
					...
					100,
					40,
					`{"2023-01-15": [{"symbol": "EXAMPLE", "name": "Example Corporation", "exchange": "NASDAQ"}], "2023-01-20": [{"symbol": "TEST", "name": "Test Inc", "exchange": "NYSE"}]}`,
					"/?country=US&end_date=2023-01-31&exchange=NASDAQ&mic_code=XNAS&start_date=2023-01-01",
				),
			},
			want: response.IPOCalendar{
				"2023-01-15": {{Symbol: "EXAMPLE", Name: "Example Corporation", Exchange: "NASDAQ"}},
				"2023-01-20": {{Symbol: "TEST", Name: "Test Inc", Exchange: "NYSE"}},
			},
		...
		},
		{
			...
			args: args{
				...
				url: mockServerWithURL(
					...
					100,
					40,
					`{"2023-02-15": [{"symbol": "NEWCO", "name": "New Company Ltd", "exchange": "NYSE"}]}`,
					"/",
				),
			},
			want: response.IPOCalendar{
