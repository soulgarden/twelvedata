				...
				Values: []response.MarketMover{
					{
						...
						MicCode:       "XNAS",
						Datetime:      "2023-10-01T12:00:00Z",
						Last:          null.FloatFrom(17.25),
						High:          null.FloatFrom(18),
						Low:           null.FloatFrom(16.5),
						Volume:        null.IntFrom(108297),
						Change:        null.FloatFrom(3.31),
						PercentChange: null.FloatFrom(23.74462),
					},
				},
				Status: "ok",
			},
	...
	tests := []struct {
	...
	}{
		{
			...
			want: response.Quote{
				...
				Currency:        "USD",
				Datetime:        "2021-09-16",
				Timestamp:       null.IntFrom(1631772000),
				LastQuoteAt:     null.IntFrom(1631772000),
				Open:            "148.44000",
				High:            "148.96840",
				Low:             "147.22099",
				Close:           "148.85001",
